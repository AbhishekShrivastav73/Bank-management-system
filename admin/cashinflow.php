...
if (!$result) {
    die('Error fetching deposit transactions: ' . mysqli_error($con));
}
    ...
    <div class="d-flex">
        ...
        <div class="flex-grow-1 overflow bg">
            ...
            <div class="d-flex  align-items-center justify-content-between">
                ...
                <h1 class="fs-5 lh-1">Cash In-flow Details</h1>
                <p class="fs-5 lh-1 fw-bold text-secondary">Total Cash In-flow : <?php echo number_format($totalAmount, 2); ?></p>
            </div>
                <!-- Transaction Table -->
